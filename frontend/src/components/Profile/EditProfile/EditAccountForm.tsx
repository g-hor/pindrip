...
const EditAccountForm = () => {
	...
	const handlePassword = () => {
		if (!notMatch) {
			return dispatch(updatePassword({ id, email, oldPw, newPw })).catch(async (res) => {
				let data;
				try {
			...
			<div id="edit-profile-side-plus-form-holder">
				...
				<div id="edit-form-container">
					<div className="edit-form-header-container">
						<div>
							<h1 className="edit-form-title">Account management</h1>
						</div>

						<div>
							<h3 className="edit-form-description">
								Make changes to your email and password. This information is private and won't show up in your
								public profile.
							</h3>
						</div>
					</div>
					...
					<div id="delete-acc-holder">
						<div id="delete-text-holder">
							<div id="delete-title">Delete your data and account</div>
							<div id="delete-description">Delete your account and account data</div>
						</div>
					...
					{!isDemo && showPw && (
						<Modal onClose={closeReset}>
							<div id="change-pw-form-container">
								<div className="edit-form-header-container">
									<h1 className="edit-form-title pw-header">Change your password</h1>
								</div>

								<div className="edit-form-label">Old password</div>
								...
								<div className="edit-form-label">New password</div>
								<div className="password-field-holder">
									<input
										className="edit-text-input-field pw-modal-text"
										type="password"
								...
								<div className="password-field-holder">
									<input
										...
										onChange={(e) => {
											...
											setNotMatch(newPw !== e.target.value);
										}}
									/>
								</div>
								<div className="edit-form-label match-pw">{errors.map((error) => error)}</div>
								{notMatch && <div className="edit-form-label match-pw">Passwords must match!</div>}
								...
								<div id="pw-btn-holder">
									...
									<div className="change-pw-btn" onClick={handlePassword}>
										Change Password
									</div>
								</div>
							</div>
					...
					{!isDemo && showConfirm && (
						<Modal onClose={closeReset}>
							<div id="confirm-delete-container">
								<div className="edit-form-header-container">
									<h1 className="edit-form-title pw-header">We will miss your drip, {username}</h1>
								</div>

								<div className="edit-form-label">Enter your password</div>
								<div className="password-field-holder">
									<input
										className="edit-text-input-field pw-modal-text"
										type="password"
										onChange={(e) => {
											...
											setNotMatch(confirmNewPw !== e.target.value);
										}}
									/>
								</div>
								...
								<div className="edit-form-label match-pw">{errors.map((error) => error)}</div>
								{notMatch ? (
									<div className="edit-form-label match-pw">Passwords must match!</div>
								) : (
								...
								<div id="pw-btn-holder">
									...
									<div className="change-pw-btn" onClick={handleDelete}>
										Delete account
									</div>
								</div>
							</div>
