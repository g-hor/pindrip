...
const EditProfileForm = () => {
	...
	const handlePhoto = async ({ currentTarget }) => {
		if (currentTarget.files[0]) {
			...
			formData.append('user[id]', String(currentUser.id));
		}
	...
	const saveChanges = async () => {
		if (canSubmit) {
			...
			dispatch(
				receiveSession({ ...currentUser, firstName: first, lastName: last, about, pronouns, website, username }),
			);
	...
	}, [showPronouns, first, last, about, pronouns, website, username]);
			...
			<div id="edit-profile-side-plus-form-holder">
				...
				<div id="edit-form-container">
					<div className="edit-form-header-container">
						<div>
							<h1 className="edit-form-title">Public profile</h1>
						</div>

						<div>
							<h3 className="edit-form-description">People visiting your profile will see the following info</h3>
						</div>
					</div>
					...
					<div className="edit-form-label">Photo</div>
					...
					<div className="edit-form-field-row-holder">
						...
						<div id="change-avatar-btn" onClick={() => setShowUpload(true)}>
							Change
						</div>
					</div>
					...
					{showUpload && (
						<Modal onClose={() => setShowUpload(false)}>
							<div id="upload-avatar-container">
								<div className="edit-form-header-container">
									<h1 className="edit-form-title">Change your picture</h1>
								</div>

								<div id="upload-img-btn" onClick={() => imgButtonInput.current.click()}>
									Choose photo
								</div>
					...
					<div className="edit-form-field-row-holder">
						<div className="edit-form-field-holder">
							<div className="edit-form-label">First name</div>
						...
						<div className="edit-form-field-holder">
							<div className="edit-form-label">Last name</div>
					...
					<div className="edit-form-field-row-holder">
						<div className="edit-form-field-holder">
							<div className="edit-form-label">About</div>
					...
					<div className="edit-form-field-row-holder">
						<div className="edit-form-field-holder">
							<div className="edit-form-label">Pronouns</div>
									...
									{pronouns && (
										<div id="selected-pronouns">
											...
											<div id="remove-pronouns">
												<i className="fa-solid fa-xmark" onClick={removePronouns} />
											</div>
										</div>
									)}
								...
								<div ref={pronounsList}>
									{showPronouns && (
										<div id="pronouns-list">
											<div className="pronoun-option" onClick={selectPronoun}>
												ey/em
											</div>
											<div className="pronoun-option" onClick={selectPronoun}>
												he/him
							...
							<div className="edit-form-field-row-holder field-description">
								Choose a set of pronouns to appear on your profile so others know how to refer to you. You can
								edit or remove these any time.
							</div>
						</div>
					</div>
					...
					<div className="edit-form-field-row-holder website">
						<div className="edit-form-field-holder">
							<div className="edit-form-label">Website</div>
					...
					<div className="edit-form-field-row-holder">
						<div className="edit-form-field-holder">
							<div className="edit-form-label">Username</div>
