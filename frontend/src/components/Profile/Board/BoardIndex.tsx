...
const BoardIndex = ({ showUser }) => {
	...
	const [rowAmt, setRowAmt] = useState(containerWidth / 252);
		...
		<div id="boards-container" ref={boardsContainer}>
			...
			{showDrop && (
				<div id="profile-create-dropdown" ref={dropdown}>
					...
					<div className="create-option" id="create-pin-btn" onClick={() => navigate('/pin-builder')}>
						Pin
					</div>
					<div className="create-option" id="create-board-btn" onClick={() => setShowModal(true)}>
						Board
					</div>
				</div>
			)}
			...
			{showModal && (
				<Modal onClose={() => setShowModal(false)} customClass={'create-board-modal'}>
					<div id="create-board-form">
						<div id="create-board-title">Create board</div>
						<div id="create-board-row-holder">
							<div id="create-board-name-label">Name</div>
							<div>
								<input
									type="text"
							...
							<div id="create-board-bottom-bar">
								<div id="create-board-modal-btn" onClick={handleCreate} className={canSave ? 'can-save' : ''}>
									Create
								</div>
							</div>
						</div>
