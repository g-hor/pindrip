...
const EditPinForm = ({ pin, onClose }) => {
	...
	const cancelBtn = useRef<HTMLDivElement | null>(null);
		...
		<div id="edit-pin-form">
			...
			<div id="edit-pin-form-bottom-container">
				<div id="edit-pin-form-left">
					...
					<div className="edit-pin-row">
						<div className="edit-pin-row-label">Title</div>
						<div className="edit-pin-row-field">
							<input
								type="text"
								value={title}
					...
					<div className="edit-pin-row">
						<div className="edit-pin-row-label">Description</div>
						<div className="edit-pin-row-field">
							<textarea
					...
					<div className="edit-pin-row">
						<div className="edit-pin-row-label">Website</div>
						<div className="edit-pin-row-field">
							<input
								type="text"
								value={website}
					...
					<div className="edit-pin-row">
						<div className="edit-pin-row-label">Alt text</div>
						<div className="edit-pin-row-field">
							<input
								type="text"
								value={altText}
				...
				<div id="edit-pin-form-right">
					<img src={pin?.photo} alt={altText} id="edit-pin-img" />
				</div>
			</div>

			<div id="edit-pin-form-bottom-bar">
				<div className="edit-pin-btn delete" onClick={() => dispatch(deletePin(pin?.id))}>
					Delete
				</div>

				<div id="edit-pin-bottom-btn-container">
					<div ref={cancelBtn} className="edit-pin-btn cancel" onClick={() => onClose()}>
						Cancel
					</div>
					<div className="edit-pin-btn save" onClick={() => savePin(pin)}>
						Save
					</div>
				</div>
			</div>
