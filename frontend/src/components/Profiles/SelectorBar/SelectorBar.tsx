		...
		<div id="selector-bar-container">
			<div id="selector-bar">
				<div onClick={selectCreated} id="profile-created-tab-container">
					<div id="profile-created-tab" className={createdTabClassName}>
						Created
					</div>
					{showUnderline === 'created' && <div id="profile-created-underline" />}
				</div>

				<div onClick={selectSaved} id="profile-saved-tab-container">
					<div id="profile-created-tab" className={savedTabClassName}>
						Saved
					</div>
					{showUnderline === 'saved' && <div id="profile-saved-underline" />}
				</div>
			</div>
		</div>
	);
