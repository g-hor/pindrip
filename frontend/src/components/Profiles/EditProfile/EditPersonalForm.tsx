...
const EditPersonalForm = () => {
	...
	const [isNonBinary, setIsNonBinary] = useState(!['Male', 'Female'].includes(gender));
	const [saved, setSaved] = useState(false);
	const [canSubmit, setCanSubmit] = useState(false);

	const username = currentUser?.username;
	const isDemo = currentUser?.id === 1;
	...
	const handleChange = (setField, field, e) => {
		...
		setCanSubmit(currentUser.gender !== currGender || currentUser.country !== currCountry);
	};
	...
	const resetChanges = () => {
		...
		setIsNonBinary(!['Male', 'Female'].includes(currentUser?.gender));
		setCanSubmit(false);
	};
			...
			<div id="edit-profile-side-plus-form-holder">
				...
				<div id="edit-form-container">
					<div className="edit-form-header-container personal">
						<div>
							<h1 className="edit-form-title">Personal information</h1>
						</div>

						<div>
							<h3 className="edit-form-description">
								Edit your basic personal info. This information is private and wont show up in your public
								profile.
							</h3>
						</div>
					</div>
					...
					<div className="edit-form-field-row-holder gender-row">
						<div className="edit-form-field-holder">
							<div className="edit-form-label">Gender</div>
							...
							<div id="gender-options-holder">
								<div className="gender-option">
									<input
										...
										value="Male"
										onChange={(e) => {
											handleChange(setGender, gender, e);
					...
					<div className="edit-form-field-row-holder country-holder">
						<div className="edit-form-field-holder">
							<div className="edit-form-label">Country/Region</div>
